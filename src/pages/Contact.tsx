        ...
        <section className="bg-[#FFFFF7] dark:bg-[#323436]">
            <section className="px-4 sm:px-10 py-5">
                <div className="">
                    ...
                    <iframe src="https://www.google.com/maps/embed/v1/place?q=Kacheripady,+Kochi,+Kerala,+India&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" width="600" height="450" className="border-0 w-full" allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                ...
                <div className="block 1100px:flex justify-evenly my-5 bg-white dark:bg-[#222e35] p-5 shadow-lg">
                    ...
                    <div className="text-skin-base">
                        ...
                        <address> <AiOutlineHome size={25} className="inline m-3" />Providence road, Kacheripady , Kochi, Kerala, 647517</address>
                        <a href="tel:+91 8008952100"> <BsTelephone size={25} className="inline m-3" />+91 9846393763</a>  <br />
                        <a href="mailto:venugopalreddy9493@gmail.com"> <AiOutlineMail size={25} className="inline m-3" />shopmart@gmail.co.in</a>
                        {/* <p> <AiOutlineInfoCircle size={25} className="inline m-3" />ahex-tech, </p> */}
                    </div>
                </div>
            </section>
        </section>
