...
import { account, contact, information, links,app } from "../../static/staticData"
  ...
  return (
    <>
      ...
      <footer className="py-4 800px:w-full text-center 800px:justify-evenly 800px:flex">
        ...
        {/* <div className="flex flex-col font-bold flex-wrap text-white font-light  cursor-pointer hover:underline">
          <h5>Our App</h5> */}
          {/* <p>Download Our App and get extra <br />15% Discount on your first Order.</p>
           */}
           <div className="flex flex-col">
          <h5 className="text-white font-bold underline">Our App</h5>
          {app && app.map((item) => (
            <p key={item} className="text-white font-light cursor-pointer py-1 ease-out transition-all hover:text-[1.01rem] hover:translate-x-1 ">{item}</p>
          ))}
      ...
      <footer className="py-3 ">
        <div className="w-full">
          <p className="text-center mb-0 text-white">
            &copy;{new Date().getFullYear()};  Powered By Irvin Jacob Sam
          </p>
        </div>
      </footer>
    </>
